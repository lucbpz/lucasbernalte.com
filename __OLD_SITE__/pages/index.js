        ...
        <div style={{ position: "relative", height: "1px", width: "110%" }}>
          <div
            style={{
              ...
              background:
                colorMode === "light"
                  ? "url(/static/images/web-bg.png)50% 0 no-repeat"
                  : "url(/static/images/web-bg-inverted.png)50% 0 no-repeat",
              opacity: 0.15,
              maskImage: "linear-gradient(to top,transparent 20%,black 80%)",
              WebkitMaskImage:
                "linear-gradient(to top,transparent 20%,black 80%)",
            }}
          ></div>
        </div>
        <Flex
