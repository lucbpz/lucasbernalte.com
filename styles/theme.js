...
const theme = {
  ...
  fonts: {
    ...chakraTheme.fonts,
    heading: 'sora, Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Helvetica',
    body: `sora, Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"`
  },
  fontWeights: {
    normal: 400,
    medium: 600,
